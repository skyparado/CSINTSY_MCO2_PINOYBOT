...
def train_model():
    ...
    clf_pipeline = Pipeline([
        ...
        ("classifier", RandomForestClassifier(n_estimators=300, random_state=42, verbose=1, class_weight="balanced")) # use RandomForestClassifier with 300 trees and a fixed random state for reproducibility
    ])
